...
function insertCheat(section, shortcut, description) {
...
const generator = function () {
    ...
    insertCheat("basic movement","h","left one character");
    insertCheat("basic movement","l","right one character");
    insertCheat("basic movement","j","down one row");
    insertCheat("basic movement","k","up one row");
    insertCheat("word movement","w","start of next word");
    insertCheat("word movement","W","start of next WORD");
    insertCheat("word movement","b","start of previous word");
    insertCheat("word movement","B","start of previous WORD");
    insertCheat("word movement","e","end of word");
    insertCheat("word movement","E","end of WORD");
